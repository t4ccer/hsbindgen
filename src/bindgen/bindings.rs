...
use crate::bindgen::language_backend::{
    CLikeLanguageBackend, CythonLanguageBackend, HaskellLanguageBackend, LanguageBackend,
};
...
impl Bindings {
    ...
    pub fn write<F: Write>(&self, file: F) {
        match self.config.language {
            ...
            Language::Haskell => {
                self.write_with_backend(file, &mut HaskellLanguageBackend::new(&self.config))
            }
        }
    }
